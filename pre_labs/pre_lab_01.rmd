...
**Answer: 79,366 observations, 9 variables.**
...
In the space below, write the name of the course from the first row of the "name" column. **Answer**
...
**Every term is now split by department name.**
...
**The list is now sorted in descending number of total seats per term.**
...
**We now have averages for how many seats per term via median and mean. The top terms almost exclusively take place in the Fall or Spring terms.**
...
**The data is now sorted by number of seats per department.**
...
1.  What courses have been discontinued? Is it possible to see that reflected in the data?

2.  What department has the most classes offered in the summer?

3.  What department has the most seats on average?
